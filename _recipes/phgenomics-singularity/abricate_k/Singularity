...
%post
 # set versions of software to install
  ...
  sudo apt-get --yes install make wget unzip gzip emboss git bioperl libjson-perl libtext-csv-perl libfile-slurp-perl liblwp-protocol-https-perl libwww-perl liblist-moreutils-perl libpath-tiny-perl
