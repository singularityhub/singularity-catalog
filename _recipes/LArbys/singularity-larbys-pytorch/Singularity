Bootstrap: docker
From: twongjirad/larbys-pytorch
...
%post
  ...
  ./gpu4singularity --full-url=http://us.download.nvidia.com/XFree86/Linux-x86_64/375.20/NVIDIA-Linux-x86_64-375.20.run --nvidia-version 375.20
  cd ../
  rm -rf gpu4singularity
