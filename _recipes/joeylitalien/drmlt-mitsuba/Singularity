...
%post
    ...
    pacman -Sy --noconfirm emacs-nox bash-completion make boost eigen gcc openexr python3 fftw libpng jasper zlib cmake git awk xerces-c xorg glew openimageio python-pip
